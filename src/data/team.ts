...
export const teamMembers: TeamMember[] = [
  {
    ...
    enjoysMost: 'The quiet moment when a client sees themselves in the mirror and truly lights up',
    funFact: 'She has an entire room in her home dedicated to her collection of vintage Vogue issues dating back to 1965.',
  ...
  },
  {
    ...
    yearsExp: 9,
    favoriteStyle: 'Soft, multi-tonal dimensional highlights that catch light like a painting',
    enjoysMost: 'Solving complex color corrections — the more challenging, the better',
    funFact: 'She competes annually in regional floristry competitions and has won three times.',
  ...
  },
  {
    ...
    enjoysMost: 'Working with clients who want to try something bold and trust the process',
    funFact: 'In his spare time, he restores vintage motorcycles — a 1974 BMW R90/6 is his current project.',
  ...
  },
  {
    ...
    name: 'Olivia Park',
    role: 'Color Artist',
    image: 'https://images.unsplash.com/photo-1488716820095-cbe80883c496?w=800&q=80',
    ...
    yearsExp: 6,
    favoriteStyle: 'Peachy, buttery blonde balayage — warm, glowy, and effortlessly beautiful',
    enjoysMost: 'The trust clients place in her when they\'re ready for a big change',
    funFact: 'She makes ceramics in her home studio and gifts handmade mugs to clients on milestone appointments.',
  ...
  },
  {
    ...
    yearsExp: 8,
    favoriteStyle: 'A clean mid-fade with soft texture on top — timeless and always sharp',
    enjoysMost: 'Building long-term relationships with regular clients who trust him to evolve their look',
    funFact: 'He is an amateur coffee roaster and brings small-batch roasts from his home setup to share with the team each week.',
  ...
  },
  {
    ...
    funFact: 'She teaches ballroom dance on weekends and credits it for her exceptional spatial awareness and sense of movement.',
